...
class LLM:
    ...
    def generate(
        ...
        # pdb.set_trace()
        if read_pt is not None:
            tokenization_kwargs['read_pt'] = read_pt
    ...
    def _validate_and_add_requests(
        ...
        *,
        ...
        read_pts = None
        if 'read_pt'  in tokenization_kwargs:
            read_pts = deepcopy(tokenization_kwargs["read_pt"])
        
        for i, prompt in enumerate(it):
            if read_pts is not None:
                read_pt = read_pts[i]
                tokenization_kwargs["read_pt"] = [read_pt]
            self._add_request(
                prompt,
