...
class DataArguments:
    ...
    lazy_processing: bool = field(
        default=False,
        metadata={"help": "Enable lazy processing to process data in real-time during training."}
    )
    pt_dir: Optional[str] = field(
        default=None,
        metadata={"help": "Path to store the extracted feature"}
    )
